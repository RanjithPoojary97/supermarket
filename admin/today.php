                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="editservice.php">Edit services</a></li>
                            <li><i class="fa fa-table"></i><a href="listservices.php">Delete Services</a></li>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">listservices</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"> today Schedules</strong>
                        </div>
                        <div class="card-body">
...
$i=1;
    ...
    while($row=mysqli_fetch_object($res))
    {
      ...
      echo "<td>" .$row->name. "</td>";
     // echo "<td>" .$row->time. "</td>";
     // echo "<td><a href='editsales.php?serviceid=$row->serviceid'>Edit</a>   <a href='editservice.php?serviceid=$row->serviceid' onclick='return deleteConfirm();'>Delete</a></td>";
