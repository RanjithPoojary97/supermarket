...
$i=1;
    ...
    while($row=mysqli_fetch_object($res))
    {
      ...
      echo "<td>" .$row->cost. "</td>";
      echo "<td><a href='editservice.php?serviceid=$row->serviceid'>Edit</a>   <a href='deleteservice.php?serviceid=$row->serviceid' onclick='return deleteConfirm();'>Delete</a></td>";
