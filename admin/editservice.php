                    ...
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="update.php" method="post" class="form-horizontal">
                           ...
                           <input type="text" class="form-control" id="servicename" value="<?php echo $row[1]; ?>" name="servicename">
                           </div>
                           <div class="form-group">
                           <label for="text">Service Cost</label>
                           <input type="text" class="form-control" id="cost" value="<?php echo $row[2]; ?>" name="cost">
                           </div>

                           <input type="hidden" class="form-control" value="<?php echo $serviceid; ?>" name="serviceid">
