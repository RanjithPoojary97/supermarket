                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">listcustomer</li>
                        </ol>
                    </div>
                </div>
            </div>
...
$i=1;
    ...
    while($row=mysqli_fetch_object($res))
    {
      ...
      echo "<td><a href='editcustomer.php?id=$row->id'>Edit</a>   <a href='deletecustomer.php?id=$row->id' onclick='return deleteConfirm();'>Delete</a></td>";
